      ...
      >
        <div class="flex justify-center">
          <img
            ...
            src="https://avatars.githubusercontent.com/u/156638199?v=4"
            alt="Foto"
          />
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everybody! My name is Muh. Fikhru Maulana. I
            am a web developer from Makassar, South Sulawesi. I have 1 year
            experience in front-end web development. I really enjoy what I am
            doing now, in my opinion making programs is not just a job, but also
            a hobby.
          </p>
